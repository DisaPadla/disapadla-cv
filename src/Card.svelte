...
<style>
  ...
  100% {
    ...
    padding-left: 50px;
    background: #2c2e2d;
    animation: entrance-card 1s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;
  ...
  .time-section__time {
    ...
    color: #d5dfe0;
    width: 160px;
    animation: entrance-time 2s cubic-bezier(0.550, 0.085, 0.680, 0.530) both;
  }
...
<section>
  <div class='time-section'>
    <span class='time-section__time'>{time}</span>
  </div>
  <div class='content'>
    <div class='header'>
      <h3>{title}</h3>
